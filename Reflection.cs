...
namespace Pangolin
{
    class Reflection
    {
        ...
        static public object RunMethod(string className, object instance, string methodName, object[] parameters)
        {
            string assemblyName = "KSP_x64_Data/Managed/Assembly-CSharp.dll";
        ...
        static public object GetField(string className, object instance, string fieldName)
        {
            string assemblyName = "KSP_x64_Data/Managed/Assembly-CSharp.dll";
